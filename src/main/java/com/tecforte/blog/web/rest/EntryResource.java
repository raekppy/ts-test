...
public class EntryResource {
    ...
    public ResponseEntity<EntryDTO> createEntry(@Valid @RequestBody EntryDTO entryDTO) throws URISyntaxException {
        ...
        if (entryDTO.getEmoji().toString().equals("SAD") || entryDTO.getEmoji().toString().equals("ANGRY")) {
        	throw new BadRequestAlertException("Invalid Emoji", ENTITY_NAME, "invalidEmoji");
        }
        
        if (entryDTO.getContent().toString().equals("Angry") || entryDTO.getContent().toString().equals("Sad") || entryDTO.getContent().toString().equals("Fear") || entryDTO.getContent().toString().equals("Cry")
        		|| entryDTO.getContent().toString().equals("Lonely") || entryDTO.getContent().toString().equals("Like") || entryDTO.getContent().toString().equals("Love") || entryDTO.getContent().toString().equals("Happy") 
        		|| entryDTO.getContent().toString().equals("Haha") || entryDTO.getContent().toString().equals("Laugh")) {
